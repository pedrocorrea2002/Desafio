...
public class Desafio {
	public static void main(String[] args){
		...
		System.out.println(" -----------------");
		System.out.println("Digite a posição na horizontal que deseja inserir a torre");
		{while((X == 0)|((X<1)&(X>8))){	
			try{
		...
		System.out.println("Agora digite a posição na vertical que deseja inserir a torre");
		{while((Y == 0)|((Y<1)&(Y>8))){	
			try{
